    ...
    const handleCheckboxChange = (category, item) => {
      ...
      if (category === "tipo") {
          setBurgerOptions(prevState => ({
              ...prevState,
              tipo: { simple: false, doble: false, triple: false, [item]: !prevState.tipo[item] },
          }));
      } else {
          setBurgerOptions(prevState => ({
              ...prevState,
              [category]: { ...prevState[category], [item]: !prevState[category][item] }
          }));
      }
  };
            ...
            <Modal show={show} onHide={handleClose} backdrop="static" keyboard={false}>
                ...
                <Modal.Body>
                    ...
                    <div className="d-flex justify-content-center align-items-center">
                        <Button className='mx-3' variant="outline-secondary" onClick={() => handleCantidadChange(-1)}>-</Button>
