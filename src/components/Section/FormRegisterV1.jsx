        ...
        <Row className='box1'>
                <Col md={6} className="text-center text-md-start p-sm-2 d-none d-lg-block">
                    <div className="text-white p-4">
                        ...
                        <h2>Te esperamos</h2>
                        <p>Horario <br/>
                        <b>De Martes a Domingo, de 8:00h a 23:00h.</b><br />
                        <a href="https://www.argentina.gob.ar/interior/feriados-nacionales-2024">Ver calendarios festivos</a></p>
                    </div>
                    <div>
                ...
                <Form onSubmit={handleSubmit}>
                            <Form.Group className="mb-3" controlId="formBasicFecha">
                                <Form.Label className='mx-3 text-white'>Fecha y Hora</Form.Label>
                                <DatePicker
                                    selected={startDate}
                     ...
                     <Form.Group className="mb-3" controlId="formNumComensales">
                                ...
                                <Form.Control
                                    ...
                                    value={numComensales}
                                    onChange={(e) => setNumComensales(Math.max(1, e.target.value))}
                                    min="1"
                                />
                            </Form.Group>
